...
SuvirvalRootPath=/home/adrian/development/unreal/Suvirval

gameProjectFile=/home/adrian/development/unreal/Suvirval/Suvirval.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(SuvirvalSource.pri)
include(SuvirvalHeader.pri)
include(SuvirvalConfig.pri)
include(SuvirvalIncludes.pri)
include(SuvirvalDefines.pri)
...
Suvirval-Linux-Debug.commands = $$build Suvirval Linux Debug  -project="\"$$gameProjectFile\"" $$args
Suvirval-Linux-DebugGame.commands = $$build Suvirval Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Suvirval-Linux-Shipping.commands = $$build Suvirval Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Suvirval-Linux-Test.commands = $$build Suvirval Linux Test  -project="\"$$gameProjectFile\"" $$args
Suvirval.commands = $$build Suvirval Linux Development  -project="\"$$gameProjectFile\"" $$args

SuvirvalEditor-Linux-Debug.commands = $$build SuvirvalEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
SuvirvalEditor-Linux-DebugGame.commands = $$build SuvirvalEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
SuvirvalEditor-Linux-Shipping.commands = $$build SuvirvalEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
SuvirvalEditor-Linux-Test.commands = $$build SuvirvalEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
SuvirvalEditor.commands = $$build SuvirvalEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Suvirval-Linux-Debug \
	Suvirval-Linux-DebugGame \
	Suvirval-Linux-Shipping \
	Suvirval-Linux-Test \
	Suvirval \
	SuvirvalEditor-Linux-Debug \
	SuvirvalEditor-Linux-DebugGame \
	SuvirvalEditor-Linux-Shipping \
	SuvirvalEditor-Linux-Test \
	SuvirvalEditor \
