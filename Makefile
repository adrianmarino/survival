...
Suvirval-Linux-Debug:
	 $(PROJECTBUILD) Suvirval Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Suvirval-Linux-DebugGame:
	 $(PROJECTBUILD) Suvirval Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Suvirval-Linux-Shipping:
	 $(PROJECTBUILD) Suvirval Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Suvirval-Linux-Test:
	 $(PROJECTBUILD) Suvirval Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Suvirval:
	 $(PROJECTBUILD) Suvirval Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SuvirvalEditor-Linux-Debug:
	 $(PROJECTBUILD) SuvirvalEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SuvirvalEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SuvirvalEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SuvirvalEditor-Linux-Shipping:
	 $(PROJECTBUILD) SuvirvalEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SuvirvalEditor-Linux-Test:
	 $(PROJECTBUILD) SuvirvalEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SuvirvalEditor:
	 $(PROJECTBUILD) SuvirvalEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
